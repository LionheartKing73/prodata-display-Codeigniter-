        ...
        <div class="theme-ad-banner-content theme-display-table theme-no-gutter">
            ...
            <div class="theme-lg-9 theme-sm-7 theme-xs-12 theme-ad-desc-col theme-table-middle-cell">
                <div class="theme-ad-content">
                    <h2><a href="<%= data.destination_url %>" target="_blank"><%= data.title %></a></h2>
                    <p><%= data.description_1 %></p>
                    <p><%= data.description_2 %></p>
                    <p class="theme-ad-url-line"> <a href="<%= data.destination_url %>" target="_blank"><%= data.display_url %></a></p>
                </div>
            </div>
        </div>
