                        ...
                        <div class="theme-ad-subrow theme-ad-banner-subrow text_ads">
                            ...
                            <div class="theme-create-ad-form-wrap">
                                <div class="theme-geoform-group theme-form-group theme-inline-group">
                                    ...
                                    <input name="title" maxlength="25"  type="text" value="" placeholder="Enter the title of your ad" class="theme-geoform-control theme-form-control" />
                                ...
                                <div class="theme-geoform-group theme-form-group theme-inline-group">
                                    ...
                                    <textarea name="description_1" maxlength="35" placeholder="Enter the desc of your ad" class="theme-geoform-control theme-form-control"></textarea>
                                    <span style="font-size:12px; color: #999898; padding-left:143px;"> Character Left: <span class="charecter_count" maxlength="35">35</span> </span>
                                </div>
                                <div class="theme-geoform-group theme-form-group theme-inline-group">
                                    <label class="theme-inline-label theme-light-weight">Description 2</label>
                                    <textarea name="description_2" maxlength="35" placeholder="Enter the desc of your ad" class="theme-geoform-control theme-form-control"></textarea>
                                    <span style="font-size:12px; color: #999898; padding-left:143px;"> Character Left: <span class="charecter_count" maxlength="35">35</span> </span>
                                </div>
                                <div class="theme-geoform-group theme-form-group theme-inline-group">
                                    <label class="theme-inline-label theme-light-weight">Display Url:</label>
                                    <input name="display_url" type="url" value="" placeholder="Enter the display url of your ad" class="theme-geoform-control theme-form-control" maxlength="25" />
                                    <span style="font-size:12px; color: #999898; padding-left:143px;"> Character Left: <span class="charecter_count" maxlength="25">25</span> </span>
                                </div>
                                <div class="theme-geoform-group theme-form-group theme-inline-group">
                                    <label class="theme-inline-label theme-light-weight">URl:</label>
                                    <input name="destination_url" type="url" value="" placeholder="Enter the url of your ad" class="theme-geoform-control theme-form-control" maxlength="35" />
                                    <span style="font-size:12px; color: #999898; padding-left:143px;"> Character Left: <span class="charecter_count" maxlength="35">35</span> </span>
                                </div>
                                <div class="theme-geoform-group theme-form-group theme-inline-group">
                ...
                <div class="theme-create-ad-form-wrap">
                    <div class="theme-geoform-group theme-form-group theme-inline-group large">
                        ...
                        <div class="tab-pane" id="heatmap_creative">
                            <iframe style="margin:0; padding:0; border:1; width:99%; height:625px; position:relative; overflow-x:hidden; overflow-y:scroll;" id="heatmap_creative_iframe" class="hidden"></iframe>
                        </div>
                ...
                <div class="theme-display-table theme-no-gutter theme-no-gutter">
                    ...
                    <div class="theme-lg-6 theme-sm-6 theme-xs-12 theme-two-col theme-sidebar-ad-col theme-table-top-cell">
                        <div class="theme-ad-subrow theme-ad-banner-subrow theme-imagead-banner-subrow">
                            ...
                            <div id="ads_container" class="theme-scrollable-ad-wrap theme-nicescroll-holder ads_container">
