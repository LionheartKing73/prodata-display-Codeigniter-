                            ...
                            <div class="modal-body">
                                ...
                                <div class="newAdd">
                                    ...
                                    <div class="form-group">
                                        <input id="fb_ad_title" placeholder="Title" maxlength="30" required="" class="form-control theme-geoform-control" type="text" name="title">
                                    </div>
                                    <div class="form-group">
                                        <textarea id="fb_ad_body" placeholder="Description" maxlength="90" required="" class="form-control theme-geoform-control" name="fb_description"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" id="fb_ad_link_description" placeholder="Link Description" maxlength="120" required="" class="form-control theme-geoform-control" name="link_description">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input name="fb_page_id" id="fb_page_id" type="hidden" value="{$ads[0]['fb_page_id']}" class="theme-form-control theme-geoform-control" />
