                            ...
                            <div class="modal-body">
                                ...
                                <div class="newAdd theme-create-ad-form-wrap">
                                    ...
                                    <div class="form-group">
                                        <input id="fb_ad_title" maxlength="50" required="" class="form-control theme-geoform-control" type="text" name="title" placeholder="Title for ad">
                                    </div>
                                    <div class="form-group">
                                        <textarea id="fb_ad_body" maxlength="160" required="" class="form-control theme-geoform-control" name="description_1" placeholder="Description for ad"></textarea>
                                    </div>
                                    <div class="form-group">
