                            ...
                            <div class="modal-body">
                                ...
                                <div class="newAdd">
                                    ...
                                    <div class="form-group">
                                        <input id="fb_ad_title" maxlength="30" placeholder="Title" required="" class="form-control theme-geoform-control" type="text" name="title">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="hidden" name="type_fb_page_like" value="true" >
                                    <input name="campaign_id" id="campaign_id" type="hidden" value="{$campaign.id}" class="theme-form-control theme-geoform-control" />
            ...
            <div class="newCampaign">
                ...
                <div class="col-md-7 col-sm-6 col-xs-9" >
                    ...
                    <div class="col-md-12 col-xs-12">
                        ...
                        <p><span class="txt_bold" >Total Likes</span> : {if !$ad.clicks_count}0{else}{$ad.clicks_count}{/if}</p>
