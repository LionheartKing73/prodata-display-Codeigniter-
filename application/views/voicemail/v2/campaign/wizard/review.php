<fieldset class="display_none">
    <div class="theme-tab-content theme-report-tab-content">
        ...
        <div id="campaign_review" class="theme-ad-banner-row theme-ad-creative-row">
                ...
                <div class="theme-lg-6 theme-sm-6 theme-xs-12 theme-two-col theme-table-top-cell">
                    <div class="theme-summary-reivew-row">
                        <div class="theme-summy-subrow">
                            <h2 id="summary_campagain_type"></h2>
                            ...
                            <p id="campaign_info_name" >Campaign Name: <span></span></p>
                            <p id="campaign_info_vertical" >Campaign Vertical: <span></span></p>
                            <p id="campaign_info_domain_name" >Domain Name: <span></span></p>
                            <p id="campaign_info_daily_budget" >Daily Budget: <span></span></p>
                            <p>Campaign Duration:</p>
                            <p id="campaign_info_start_date" class="child_p">Start: <span></span></p>
                            <p id="campaign_info_end_date" class="child_p">End: <span></span></p>
                            <p id="campaign_info_end_p" >Campaign END criteria:</p>
                            <p id="campaign_info_max_budget" class="child_p">Max Budget: <span></span></p>
                            <p id="campaign_info_max_impressions" class="child_p">Max Impressions: <span></span></p>
                            <p id="campaign_info_max_clicks" class="child_p">Max Clicks: <span></span></p>

                        </div>
                        <div class="theme-summy-subrow">
                            <h2>Summary of Digital Rooftop</h2>
                            <p id="geo_loaction_info" >Geo location:</p>
...
<!--                            <p id="prefered" >Preferrd Mobile : <span></span></p>-->
                        ...
                        <div class="theme-summy-subrow hidden" id="ppc_review_div">
                            <h2>Email to PPC information</h2>
                            <p id="total_records_show" >Total records : <span></span></p>
                            <p id="opens_show" >Opens : <span></span></p>
                            <p id="clicks_show" >Clicks : <span></span></p>
                        </div>
                    </div>
                </div>
                <div class="theme-lg-6 theme-sm-6 theme-xs-12 theme-two-col theme-sidebar-ad-col theme-table-top-cell">
                    <div class="theme-ad-subrow theme-ad-banner-subrow">
                        ...
                        <div class="theme-scrollable-ad-wrap theme-nicescroll-holder scroll" id="ads_finish_prev">
                        </div>
                    </div>
                </div>
