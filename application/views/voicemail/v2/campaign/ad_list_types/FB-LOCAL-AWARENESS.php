...
<section class="theme-container" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="row" >
        <div class="campaign-info" >
            ...
            <h4 class="pull-left">START DATE : <span>{if !empty($campaign.campaign_start_datetime)}{$campaign.campaign_start_datetime|date_format:"%Y/%m/%d %H:%M"}{/if}</span></h4>
            <h4 class="endDateBlock">END DATE : <span>{if !empty($campaign.campaign_end_datetime)}{$campaign.campaign_end_datetime|date_format:"%Y/%m/%d %H:%M"}{/if}</span></h4>
            <hr>
            {if !$editable}
            ...
            <div class="newCampaign">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    {if !$ad.video_url}
                        ...
                        {/if}
                    {else}
                        <video width="320" height="auto" controls class="theme-imagead-subrow-bottom"><source src="{$ad.video_url}"type="video/mp4">Your browser does not support the video tag.</video>
                    {/if}
                </div>
            ...
            <div class="newCampaign">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    {if $ad.creative_height > 155}
                    <img class="img-responsive fade in" data-trigger="hover" data-trigger="hover" data-toggle="popover"  data-content="<img src='{$ad.creative_url}' />" src="{$ad.creative_url}" />
                    {else}
                    {$margin = (155 - $ad.creative_height) / 2}
