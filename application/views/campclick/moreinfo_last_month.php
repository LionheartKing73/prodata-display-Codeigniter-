{include file="campclick/sections/header.php"}
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="span10">
        <div class="row"><div class="span7"><div class="btn-group" style="margin-bottom: 20px; margin-left: 10px">
                    <a class="btn " href="{$base_url}campclick/moreinfo/{$io}/{$counter}">24 Hours</a>
                    <a class="btn btn-inverse" href="{$base_url}campclick/moreinfo_last_month/{$io}/{$counter}">Last 30 days</a>
                	...
                	<form name="date-select" id="date-select" action="{$base_url}campclick/moreinfo_last_month/{$io}/{$counter}" method="post">
                        ...
                        <input type="hidden" name="action_url" id="action_url" value="{$base_url}campclick/more_info_date_range/{$io}/{$counter}" />
                        <input type="submit" name="submit" value="Filter" />
                        </form>
                </div></div>
        <div class="span3" style="text-align: right"><div class="btn-group" style="margin-bottom: 20px; margin-left: 10px">
                    <a class="btn " href="{$base_url}campclick/raw_data_month/{$io}/{$counter}">View Raw Data</a>
