    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="btn-group" style="margin-bottom: 20px; margin-left: 10px">
                    ...
                    <a class="btn" href="{$base_url}campclick/last_month_report/{$io}">Last 30 days</a>
        	...
        	<tbody>
        		{foreach from=$report.group_count_results item=c}
	        		<tr>
	        			...
	        			<td>{$c.dest_url}</td>
	        			<td>{$c.group_count}</td>
	        			<td><a href="{$base_url}campclick/more_info_date_range/{$io}/{$c.counter}/{$sDate}/{$eDate}"><i class="icon-eye-open"></i></a></td>
	        		</tr>
        		{/foreach}
        	</tbody>
        	</table>
