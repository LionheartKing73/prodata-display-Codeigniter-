{include file="campclick/sections/header.php"}
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="span2">
        	<h2><a href="/campclick/report/{$io}/0/{$range}/{$sDate}/{$eDate}">{$io}</a>: {$counter}</h2>
        	<br/>
        	<h6>
        		Campaign Report
        	</h6>
 ...
 <div class="row">
            ...
            <div class="btn-group" style="margin-bottom: 20px; margin-left: 10px">
                    <a class="btn {if $range == 'hour'}btn-inverse{/if}" href="{$base_url}campclick/raw_data/{$io}/{$counter}/{$offset}/hour">24 Hours</a>
                    <a class="btn {if $range == 'month'}btn-inverse{/if}" href="{$base_url}campclick/raw_data/{$io}/{$counter}/{$offset}/month">Last 30 days</a>
