        ...
        <div class="span10">
            <div class="row">
                <div class="span7"><div class="btn-group" style="margin-bottom: 20px; margin-left: 10px">
                        <a class="btn " href="{$base_url}campclick/export_raw_data_date_range/{$io}/{$counter}/{$sDate}/{$eDate}">Export Raw Data</a>
                ...
                <div class="span3"><div class="btn-group" style="margin-bottom: 20px; margin-left: 10px">
                        ...
                        <a class="btn " href="{$base_url}campclick/raw_data2_month/{$io}/{$counter}">Last 30 days</a>
                        <a  id="dt-range-selector" class="btn btn-inverse">Date Range</a>
                    </div><div id="date-selection-form" style="display: none; margin:15px 0">
            ...
            <table id="all-data" class="table table-bordered table-striped">
                ...
                <tr>
                    <td>{$b.ip_address}</td>
                    <td>{$b.timestamp}</td>
                    <td style=" word-wrap: break-word "><span style=" display:block; max-width:300px;word-wrap: break-word ">{$b.referrer|replace:'.bidvalidation.com':'.ppc-host.com'}</span></td>
                    <td>{if $b.web_browser|contains:"Internet" > 0}<img src="{$base_url}/static/img/browser_ie.png" />{/if} 							{if $b.web_browser|contains:"Chrome" > 0}<img src="{$base_url}/static/img/browser_chrome.png" />{/if}
                    ...
                    <td>{if $b.platform|contains:"Windows" > 0}<img src="{$base_url}/static/img/platform_windows.png" />{/if} 							{if $b.platform|contains:"Linux" > 0}<img src="{$base_url}/static/img/platform_linux.png" />{/if}
                ...
                {/foreach}
                {else}
                <tr><td colspan="5" style="text-align: center">report is empty</td> </tr>
                {/if}
                </tbody>
            </table>
            {$pagination_link}
