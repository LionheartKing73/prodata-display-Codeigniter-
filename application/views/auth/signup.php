                    ...
                    <div class="padding col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <h3 class="text-uppercase text-center">Sign up for free</h3>
                            </div>
                            <div class="panel-footer">
                                <div id="infoMessage"><?php echo $message ?></div>
                                <?php echo form_open("http://{$hostname}/auth/signup"); ?>
...
<!--                                    <label for="exp_year">Expiration Year:</label>-->
                                ...
                                <div class="col-md-12">
                                    ...
                                    <?php echo form_close(); ?>
                                    <p><a href="login" class="btn btn-info btn-lg text-uppercase">Login</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
