...
class Bing_model extends CI_Model {
    
    protected $CI;
    protected $network_id = 3;
    ...
    public function __construct()	{
        ...
        $this->CI->load->library("Bing"); 
        
    }
    
    public function create($campaign){
        
        $network_campaign_id = $this->bing->create_campaign($campaign);
    ...
    private function create_text_ad($campaign){
        ...
        foreach ($ads as $ad){
            ...
            if (isset($fiq_id['Ad']['id'])) {
                ...
                $this->V2_ad_model->update($ad['id'], ['network_creative_id' => $fiq_id['Ad']['id']]);
    ...
    public function update_ad( $ad_id = null ) {
