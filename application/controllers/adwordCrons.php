...
class AdwordCrons extends CI_Controller
{
    ...
    {   //var_dump(777); exit;
        $user = new Adwords();
        $result = $user->getNumberOfUsersIntoAudiences($user);
        //$result["destination_url"] = $destination_url;
        echo '<pre>';
    ...
    {   //var_dump(777); exit;
        ...
        $result = $user->getActiveCampaignsGenderReport($user, null, 'XML');
        //$result["destination_url"] = $destination_url;
        echo '<pre>';
    ...
    public function remcrit()
    {   //var_dump(777); exit;
        $old_criterion_row['criteria_value'] = "US";
        $old_criteria_array = explode(",", $old_criterion_row['criteria_value']); if($old_criteria_array){var_dump($old_criteria_array); exit;} exit;
        $user = new Adwords();
        $result = $user->removeCampaignCriteria($user, 334179385, array('158739245545'));
        //$result = $user->getCampaignTargetingCriteria($user, 334179385);
        //$result["destination_url"] = $destination_url;
        echo '<pre>';
        var_dump($result); exit;
    ...
    {   //var_dump(777); exit;
        $user = new Adwords();
        $result = $user->DownloadAudiencePerformanceReport($user, null, 'XML'); 
