...
class Campclick extends CI_Controller	{
    ...
    public function __construct()	{
        parent::__construct();
        return $this->redirect('v2/campaign/campaign_list');
    ...
    */
    ...
    public function index()	{
        ...
        $this->viewArray['campaigns'] = array(
            ...
            "completed" => $this->Campclick_model->get_campaign_list($userid, "Y", "campaign_is_complete='Y'"),
            //"scheduled" => $this->Campclick_model->get_campaign_list($userid, "Y", "campaign_is_started='N' AND campaign_is_complete='N' AND campaign_start_datetime >= NOW()"),
            "scheduled" => $this->Campclick_model->get_campaign_list($userid, "Y", "campaign_is_started='N' AND campaign_is_complete='N'"),
        );
