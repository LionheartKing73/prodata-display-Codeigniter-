...
$(document).ready(function(){
    ...
    $('.btn_edit_modal').on('click', function(){
        ...
        $('#ad_modal .modal-title').text('Edit your Ad');

        $("#ad_modal input[name=destination]").val(ad_data.destination);
        ...
        $("#ad_modal select[name=airpush_internal_image] option").each(function( index ) {
            //console.log($(this).text(),index);
            if($(this).text() == ad_data.airpush_image_type){
                console.log($(this));
