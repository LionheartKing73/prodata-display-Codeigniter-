var add_form = {
    creative_type : 'VIDEO-CLICKS',
    //fb_page_like  : 'fb_page_like',
...
$(document).ready(function(){
    ...
    $('#create_new_add').on('click', function(){
        ...
        $('.newAdd').find('.theme-geoform-control').each(function(key, value){
            ...
            if (!input_value && $(this.name)){
                ...
                if(button_name == 'Create New Ad') {
                    ...
                    //console.log( 555555555); return false;
                    valid_ad = false;
                    $(this).addClass('error');
                }
            }
        ...
        //console.log( valid_ad); return false;
    ...
    $("#theme-file-uploader").plupload({
        ...
        init: {
            ...
            BeforeUpload: function (up, file) {
                ...
                campaignSubType = 'FB-VIDEO-VIEWS';
                // creative_type = 'VIDEO';
    ...
    uploader.bind('FileUploaded', function (upldr, file, object) {
        ...
        if(response.status){
            ...
            $("#uploaded_image_prew").html('<figure height="320" align="center" style="padding-top:' + padding + '; margin-bottom:15px" ><video width="450" height="320" controls class="theme-imagead-subrow-bottom"><source src="' + response.file_dir +'" type="video/mp4">Your browser does not support the video tag.</video></figure>');
        }
        else {
    ...
    $('.btn_edit_modal').on('click', function(){
        ...
        $('#ad_modal .modal-title').text('Edit your Video Ad');
        ...
        $("#ad_modal textarea[name=fb_description]").val(ad_data.fb_description);
        ...
        $("#uploaded_image_prew").html('<figure height="320" align="center" style="padding-top:' + padding + '; margin-bottom:15px" ><video width="450" height="320" controls class="theme-imagead-subrow-bottom"><source src="' + ad_data.video_url +'" type="video/mp4">Your browser does not support the video tag.</video></figure>');

        //$("#uploaded_image_prew").html('<div class="theme-scrollable-ad-row">'
        //    + '<h4 class="h4_margin">VIDEO AD</h4>'
