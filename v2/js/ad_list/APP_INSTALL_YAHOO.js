...
$(document).ready(function(){
    ...
    $('#create_new_add').on('click', function(){
        ...
        $('.theme-create-ad-form-wrap').find('.theme-geoform-control').each(function(key, value){
            ...
            if (!input_value && $(this.name)){
                if(button_name == 'Create New Ad') {
                    if ($(this).attr('name') != 'ad_id' && $(this).attr('name') != 'tumblr_post_url' && $(this).attr('name') != 'ad_link_id') {
                        valid_ad = false;
                        $(this).addClass('error');
                    }
                }
            ...
            //         valid_ad = false;
            //         $(this).addClass('error');
            //         alert('The tumblr URL is ivalid.');
            //     }
            // }
    ...
    $('.btn_edit_modal').on('click', function(){
        ...
        $("#ad_modal input[name=tumblr_post_url]").val(ad_data.tumblr_post_url);
