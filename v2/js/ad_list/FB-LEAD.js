var add_form = {
    creative_type : 'DISPLAY_FACEBOOK',
...
$(document).ready(function(){
    ...
    $('#btn_add_ad').on('click', function(){
        ...
        $('#ad_modal input').not('input[name=campaign_id], input[name=fb_page_id]').val('');
...
// console.log(valid_ad);
    ...
    $('.btn_edit_modal').on('click', function(){
        ...
        $("#ad_modal input[name=link_description]").val(ad_data.link_description);
