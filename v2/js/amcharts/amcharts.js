...
(function () {
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p) {
        ...
        h >= w && (h = w);
        var A = 1 / 180 *
            Math.PI, w = b + Math.sin(e * A) * k, v = c - Math.cos(e * A) * t, x = b + Math.sin(e * A) * f, y = c - Math.cos(e * A) * g, B = b + Math.sin((e + h) * A) * f, D = c - Math.cos((e + h) * A) * g, C = b + Math.sin((e + h) * A) * k, A = c - Math.cos((e + h) * A) * t, J = {
